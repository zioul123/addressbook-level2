...
* Ability to quickly view basic statistics of the address book (`stats`: show statistics of the address book)
...
Shows the statistics of the address book, which at this point is just the number of people in the address book.
